...
| **S8a** — active workspace | ❌ **NOT STARTED — UNBLOCKED, startable now** | — | S3 landed via PR #76, which was its only blocker. Replace the four `organization.setActive` calls with the native equivalent |
