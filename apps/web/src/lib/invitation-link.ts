 ...
 *
 * The origin defaults to the browser's own origin rather than TASKDESK_AGENT_URL:
 * whoever copies the link is already reaching the app through a URL that works,
 * while TASKDESK_AGENT_URL is a server-side setting that can be stale or wrong on
