...
tools: Read, Grep, Glob, Bash, mcp__pal-mcp__analyze, mcp__pal-mcp__codereview, mcp__pal-mcp__secaudit, mcp__pal-mcp__debug, mcp__pal-mcp__refactor, mcp__pal-mcp__testgen, mcp__pal-mcp__precommit, mcp__pal-mcp__consensus, mcp__pal-mcp__thinkdeep, mcp__pal-mcp__tracer, mcp__pal-mcp__chat, mcp__pal-mcp__apilookup, mcp__pal-mcp__challenge, mcp__pal-mcp__listmodels
model: sonnet
---
...
- Never approve your own or another `pal-reviewer` instance's remediation as independent
  ...
  independence, same as any other reviewer tier.
...
- Never touch `CLAUDE.md`, `AGENTS.md`, `docs/04-engineering/agent-workflow.md`,
  ...
  `.claude/agents/` — report what you found about them; the orchestrating session makes the
  durable edit (`CLAUDE.md`, "The control plane, and who owns it").
