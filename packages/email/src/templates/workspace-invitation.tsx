...
const DEFAULT_COPY: WorkspaceInvitationEmailCopy = {
  subject: "{{inviterName}} invited you to join {{workspaceName}} on TaskDesk",
  preview: "You're invited to {{workspaceName}} on TaskDesk",
  title: "Join {{workspaceName}}",
  subtitle:
    "{{inviterName}} ({{inviterEmail}}) invited you to collaborate in TaskDesk.",
  ...
  footer: "TaskDesk workspace invitation",
};
...
WorkspaceInvitationEmail.PreviewProps = {
  ...
  copy: {
    subject:
      "{{inviterName}} invited you to join {{workspaceName}} on TaskDesk",
    preview: "You're invited to {{workspaceName}} on TaskDesk",
    title: "Join {{workspaceName}}",
    subtitle:
      "{{inviterName}} ({{inviterEmail}}) invited you to collaborate in TaskDesk.",
